    ...
    function($) {
        ...
        vc.map = {}, vc.setFrameSize = function(size) {
            ...
            render: function() {
                ...
                })), $(vc.$frame.get(0).contentWindow.document).find(".wpb-content-wrapper").length || window.vc.showMessage(window.i18nLocale.not_editable_post || "This post can not be edited with WPBakery since it is missing a WordPress default content area.", "error", "30000"), this
            },
        ...
        window.vc.events.on("shortcodeView:updated", function(model) {
            ...
            addControls: function() {
                var parentShortcodeTag, shortcodeTag = this.model.get("shortcode"),
                    ...
                    parentShortcodeTag = "vc_controls";
                this.model.setting("as_parent") && this.model.setting("content_element") && (parentShortcodeTag += " vc_controls-parent"), this.$controls = $(parentName(shortcodeTag).trim()).addClass(parentShortcodeTag), this.$controls.appendTo(this.$el)
            },
